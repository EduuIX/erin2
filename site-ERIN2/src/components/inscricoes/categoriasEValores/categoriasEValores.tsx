        ...
        <>
            <section className="categoriaEValores">
                ...
                <p>
                    ...
                    primeiro, de 01/06 (com maiores descontos) até 21/07 e o segundo, mais próximo do 
                    evento, de 22/07 até 15/08. A seguir, está a Tabela com as Categorias e Valores 
                    de Inscrição:
                </p>
                <Tabela />
            </section>
